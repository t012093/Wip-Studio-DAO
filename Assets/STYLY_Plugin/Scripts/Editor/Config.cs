...
namespace STYLY.Uploader
{
    public class Config
    {
        public static readonly string CurrentVersion = "1.6.0";
        ...
        public static readonly string AzureSignedUrls = "https://api.styly.cc/api/v1/azure/unity_plugin/signed-url";
        public static readonly string StylyAssetUploadCompleteUrl = "https://api.styly.cc/api/v1/scene/unity_plugin/complete";

        // StudioのAPI Key取得用ページのURL
        public static readonly string GetAPIKeyUrl = "https://gallery.styly.cc/me/account";
